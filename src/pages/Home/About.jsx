...
const About = () => {
    return (
        <section className="flex flex-col mt-20">
            <p className="font-semibold text-2xl md:text-3xl text-center"> A Journey of Success and Innovation</p>
            <div
                ...
                <div
                    ...
                    <div className="flex flex-row justify-center items-center">
                        ...
                        <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">75K+</p>
                    </div>
                    <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center"> Surpassed Orders fulfilled </p>
                </div>
                <div
                    className="flex flex-col justify-center items-center bg-[#FFF6F3] px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
                    <div className="flex flex-row justify-center items-center">
                        ...
                        <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">4.9</p>
                    </div>
                    <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Average Customer Rating</p>
                </div>
                <div
                    className="flex flex-col justify-center items-center bg-[#FFF6F3] px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
                    <div className="flex flex-row justify-center items-center">
                        ...
                        <p className="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-primary ml-2">24x7</p>
                    </div>
                    <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Maintained a Response time for Customer </p>
                </div>
                <div
                    className="flex flex-col justify-center items-center bg-[#FFF6F3] px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
                    <div className="flex flex-row justify-center items-center">
                    ...
                    <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Website visits </p>
                </div>
            </div>
        </section>
    )
